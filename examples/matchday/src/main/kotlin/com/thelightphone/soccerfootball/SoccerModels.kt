...
private val TEAM_SHORT_NAMES: Map<String, String> = mapOf(
    ...
    // Eredivisie, Primeira Liga, Süper Lig, MLS, Liga MX — added in 1.6.3 from
    // team-short-names-v3-approved.csv, same process as above: every key is the exact name
    // API-Football returned for that competition's 2026 season.
    // Eredivisie
    "ADO Den Haag" to "Den Haag",
    "Fortuna Sittard" to "Sittard",
    "GO Ahead Eagles" to "Go Ahead",
    "PEC Zwolle" to "Zwolle",
    "Sparta Rotterdam" to "Sparta",
    // Primeira Liga
    "Academico Viseu" to "Viseu",
    "GIL Vicente" to "Gil Vicente",
    "SC Braga" to "Braga",
    "Vitória SC" to "Vitória",
    // Süper Lig
    "Erzurumspor FK" to "Erzurumspor",
    "Gaziantep FK" to "Gaziantep",
    "Gençlerbirliği S.K." to "Gençlerbirliği",
    "Çorum FK" to "Çorum",
    // MLS
    "Atlanta United FC" to "Atlanta",
    "CF Montreal" to "Montreal",
    "Chicago Fire" to "Chicago",
    "Colorado Rapids" to "Colorado",
    "Columbus Crew" to "Columbus",
    "FC Cincinnati" to "Cincinnati",
    "FC Dallas" to "Dallas",
    "Houston Dynamo" to "Houston",
    "Inter Miami" to "Miami",
    "Los Angeles FC" to "LAFC",
    "Los Angeles Galaxy" to "LA Galaxy",
    "Minnesota United FC" to "Minnesota",
    "Nashville SC" to "Nashville",
    "New England Revolution" to "New England",
    "New York City FC" to "NYCFC",
    "New York Red Bulls" to "NY Red Bulls",
    "Orlando City SC" to "Orlando",
    "Philadelphia Union" to "Philadelphia",
    "Portland Timbers" to "Portland",
    "Real Salt Lake" to "Salt Lake",
    "San Jose Earthquakes" to "San Jose",
    "Seattle Sounders" to "Seattle",
    "Sporting Kansas City" to "Kansas City",
    "St. Louis City" to "St. Louis",
    "Toronto FC" to "Toronto",
    "Vancouver Whitecaps" to "Vancouver",
    // Liga MX
    "Atlante FC" to "Atlante",
    "Atletico San Luis" to "San Luis",
    "CF Pachuca" to "Pachuca",
    "Club America" to "América",
    "Club Queretaro" to "Querétaro",
    "Club Tijuana" to "Tijuana",
    "FC Juarez" to "Juárez",
    "Guadalajara Chivas" to "Chivas",
    "Leon" to "León",
    "Santos Laguna" to "Santos",
    "Tigres UANL" to "Tigres",
    "U.N.A.M. - Pumas" to "Pumas",
)
