...
// active use for this tool even though matchday's own build.gradle.kts doesn't depend on
...
// ship matchday only, and none of them were referenced anywhere in that module's build graph.
// Matches the trim-to-just-your-tool pattern other community forks on this SDK use (e.g. light-mail).
include(":examples:matchday")
project(":examples:matchday").projectDir = file("examples/matchday")
