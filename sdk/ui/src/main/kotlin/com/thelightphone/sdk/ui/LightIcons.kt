...
object LightIcons {
    ...
    object NUMBERED_LIST : LightIconConfiguration(
        name = "numbered list",
        drawableResource = R.drawable.ic_numbered_list_white,
    )
    object CALENDAR : LightIconConfiguration(
        name = "calendar",
        drawableResource = R.drawable.ic_calendar_white,
    )
